...
async def login(
    ...
    print(f"🔍 Login request received for username: {login_data.username}")
...
async def update_my_profile(
    ...
    print(f"🔍 Profile update request for user: {current_user.username}")
    ...
    update_data = UserUpdate(
        ...
        password=profile_data.new_password if profile_data.new_password else None
    )
    ...
    try:
        ...
        print(f"✅ Profile updated for user: {updated_user.username}")
