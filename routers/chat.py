...
async def authenticated_stream(
    ...
    print(f"✅ User authenticated for streaming: {current_user.username}")
    ...
    try:
        ...
        async def event_generator() -> AsyncGenerator[str, None]:
            try:
                ...
                # Start streaming
                import json
                print(f"🚀 Starting SSE stream for user: {current_user.username}")
                ...
                print(f"✅ Stream completed, response length: {len(response_content)}")
                ...
                if response_content and chat_messages:
                    ...
                    try:
                        ...
                        print(f"⚠️ Failed to save chat: {save_error}")
